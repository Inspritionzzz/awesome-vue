...
class MandelbrotCanvas {
    constructor(canvas) {
        ...
        this.workerPool = new WorkerPool(NUMWORKERS, "mandelbrotWorker.resources");
    ...
    render() {
        ...
        // for the code in mandelbrotWorker.resources. Collect the resulting Promise
        ...
        // Recall from mandelbrotWorker.resources that each response includes the
