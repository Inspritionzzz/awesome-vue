 ...
 * 
 * Licensed under the GPL license: http://www.gnu.org/licenses/gpl.txt To use it on other terms please contact us at info@jeasyui.com
 * 
 */
(function($){
...
_8f.toggle && (_8f.selected ? $(this).linkbutton("unselect") : $(this).linkbutton("select"));
...
_90= _8f.funcId || "";
"" != _90 && (0 == $.fn.linkbutton.funcIds.length && $.ajax({
    type: "post",
    url: _ContextPath + "/sys/base.do?method=authFunc",
    dataType: "json",
    async: !1,
    success: function(t) {
        $.fn.linkbutton.funcIds = t.split(",")
    }
}),
0 > $.inArray(_90, $.fn.linkbutton.funcIds) && t.hide())
};
